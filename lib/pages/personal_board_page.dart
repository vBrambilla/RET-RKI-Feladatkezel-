...
class _PersonalBoardPageState extends State<PersonalBoardPage> {
  ...
  void _addTask() {
    if (_formKey.currentState!.validate()) {
      ...
      projectProvider.addTask(
          'personal', newTask); // boardId helyett 'personal'
  ...
  void _updateTaskStatus(Task task, String newStatus) {
    final projectProvider =
        Provider.of<ProjectProvider>(context, listen: false);
    projectProvider.updateTaskStatus(
        'personal', task.id, newStatus); // boardId helyett 'personal'
  }
  ...
  Widget build(BuildContext context) {
    ...
    final tasks =
        projectProvider.getTasks('personal'); // boardId helyett 'personal'
